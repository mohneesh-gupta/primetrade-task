    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Sign in to access PrimeTrade</p>
        </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                ...
                <p className="text-xs text-gray-600 font-mono">admin@example.com</p>
              ...
              <div className="p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg border border-green-200">
                ...
                <p className="text-xs text-gray-600 font-mono">user@example.com</p>
                <p className="text-xs text-gray-600 font-mono">User@123</p>
              </div>
            </div>
          </div>
        </div>
